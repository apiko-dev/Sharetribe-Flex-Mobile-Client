...
(function (factory) {
  ...
  I18n.lookup = function (scope, options) {
    ...
    let locales = this.locales.get(options.locale).slice(),
  ...
  I18n.missingTranslation = function (scope, options) {
    ...
    const fullScopeWithLocale = [this.currentLocale(), fullScope].join(this.defaultSeparator);
  ...
  I18n.nullPlaceholder = function () {
    return I18n.missingPlaceholder(...arguments);
  };
